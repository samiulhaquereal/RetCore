...
Future<String?> saveFileMobile(
    type.Uint8List fileResponse, String baseFileName, String extension, String appName) async {
  ...
  try {
    ...
    if (!permissionStatus.isGranted) {
      if (permissionStatus.isDenied) {
        retcoreLogger.warning('Storage permission denied');
      } else if (permissionStatus.isPermanentlyDenied) {
        retcoreLogger.warning('Storage permission permanently denied');
        openAppSettings();
      }
      return null;
    }
    ...
    retcoreLogger.error('Error saving file: $e');
    return null;
  }
}